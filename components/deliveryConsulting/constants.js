...
const DELIVERY_TEXT = 'Improving business processes, people behaviours and\n' +
    ...
    'the ability to be adaptable and flexible to cause and\n' +
...
export { DELIVERY_TEXT, CAROUSEL_DATA };